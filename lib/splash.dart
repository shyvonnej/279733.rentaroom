...
class Splash extends StatefulWidget {
  ...
  const Splash(
      ...
      this.color3 = Colors.yellowAccent});
    ...
    return Scaffold(
      body: Center(
        ...
        children:[
          ...
          const Text("RENT",
          style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, fontFamily: 'Cambria', color: Colors.redAccent,)),
          const Text("A ROOM",
          style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, fontFamily: 'Cambria', color: Colors.redAccent,)),
      ...
      const Text("Created by ShyvonneHo",
